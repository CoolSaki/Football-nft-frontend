...
const Careers: React.FC = () => {
  ...
  useEffect(() => {
    ...
    document.querySelector('title')!.innerText = 'The Careers of meCarreira'
  }, [])
  ...
  return (
    <AppLayout headerClass="home" className="careers-layout">
      <div className="terms-container career-container">
        ...
        >
          <div className="careers-main-title ct-h1">{t('careers')}</div>
          <div id="id01" className="login-form careers-form">
            <div className="careers-main-subtitle ct-p1">
              {t(
                'Ipsum ornare porta morbi velit eu, lectus. Aliquet quam sed dictum viverra. Sit vel suscipit quam in et aliquam nibh. Orci tellus curabitur ut vel nisi scelerisque odio fames non. Sed vitae sed pretium, in tortor eu id sodales in. Tincidunt dictum convallis massa amet, fermentum at nunc.',
              )}
            </div>
            <Formik
